...
export const FOOTER_LINKS = [
  ...
  },
  {
    ...
    links: ['Tìm công ty', 'Tin tức', 'Sản phẩm dịch vụ khác', 'Liên hệ'],
  },
  {
    title: 'Điều khoản',
    links: [
...
// HOME SEARCH
export const HOME_SEARCH_SELECT = [
  {
    title: 'Ngành nghề',
    options: [
      {
...
export const HOME_CAROUSEL_SLIDES = [
  {
    subtitle: 'Tìm kiếm đối tác',
    title: 'Nhanh chóng - Uy tín - Tiết kiệm',
  ...
  {
    subtitle: "Slide's title",
    title: 'Slogan Slide 2 - SLOGAN',
...
export const COMPANY_ABOUT_CONTENT = {
  content:
...
export const COMPANY_SIZE_OPTIONS = [
  { id: '1', name: '1-10 nhân viên' },
  { id: '2', name: '11-50 nhân viên' },
  { id: '3', name: '51-200 nhân viên' },
  { id: '4', name: '201-500 nhân viên' },
  { id: '5', name: '501-1000 nhân viên' },
  { id: '6', name: '1001-5000 nhân viên' },
  { id: '7', name: '5001-10000 nhân viên' },
  { id: '8', name: '10000+ nhân viên' },
];
